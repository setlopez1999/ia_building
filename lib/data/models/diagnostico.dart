...
/// Modelo de dominio: resultado de un diagnóstico guardado.
...
/// Payload que se envía al backend al guardar un diagnóstico.
/// Destino: POST /v1/diagnosticos  (DIAG-1)
@freezed
...
/// Respuesta del backend al guardar un diagnóstico.
@freezed
